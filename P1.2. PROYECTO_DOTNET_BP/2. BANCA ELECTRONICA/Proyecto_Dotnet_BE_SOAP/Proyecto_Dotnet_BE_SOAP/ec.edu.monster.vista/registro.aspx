<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registro.aspx.cs" Inherits="Proyecto_Dotnet_BE_SOAP.ec.edu.monster.vista.registro" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <label for="uname"><b>Cédula</b></label>
            

            <asp:TextBox ID="txtcedula" runat="server"> </asp:TextBox>
            <label for="psw"><b>Cuenta</b></label>
